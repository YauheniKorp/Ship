...
class ViewController: UIViewController {
    ...
    var segmentControll: UISegmentedControl = {
        let titles = ["Battles","Classes","Outcomes", "Ships"]
    ...
    @objc func changeValue() {
        ...
        case 1:
            ...
            let storyboard: UIStoryboard = UIStoryboard(name: "ClassStoryboard", bundle: nil)
            let classVC = storyboard.instantiateViewController(withIdentifier: "class")
